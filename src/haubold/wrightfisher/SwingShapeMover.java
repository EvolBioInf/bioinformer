...
public class SwingShapeMover extends JFrame {
  ...
  public static void main(String s[]) {
    ...
    JFrame applet = new SwingShapeMover();
...
class DPanel extends JPanel implements MouseListener, MouseMotionListener {
  ...
  public void mousePressed(MouseEvent e) {
    ...
    if (rect.contains(e.getX(), e.getY())) {
      ...
      SwingShapeMover.label
      .setText("First position the cursor on the rectangle and then drag.");
      pressOut = true;
    }
  }
  ...
  public void updateLocation(MouseEvent e) {
     ...
     */
    if (checkRect()) {
      SwingShapeMover.label.setText("Rectangle located at " + rect.getX()
                                    + ", " + rect.getY());
    } else {
